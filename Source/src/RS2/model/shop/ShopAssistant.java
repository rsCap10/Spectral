	...
	public void openShop(int ShopID){		
		...
		c.getPA().sendFrame126(ShopHandler.ShopName[ShopID], 3901);
		 ...
		 for (int i = 0; i < 40*6; i += 6) {
             if (ShopHandler.ShopItems[ShopID][i/6] > 0) {
              c.getPA().sendFrame126(convertPrice(getItemShopValue(ShopHandler.ShopItems[ShopID][i/6])), 38500+i);
             }
            }
	}
   
   
	public String convertPrice(int a) {
